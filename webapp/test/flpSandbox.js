					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Riot App - REST API Portfolie App",
									"targetURL": "#riotapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"riotapp-display": {
								"semanticObject": "riotapp",
								"action": "display",
								"description": "Riot App - REST API Portfolie App",
								"title": "Riot App - REST API Portfolie App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=riot.app",
									"url": sap.ui.require.toUrl("riot/app")
								}
							}
						}
					}
